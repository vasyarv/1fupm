...
![alt text](https://upload.wikimedia.org/math/1/0/4/104cdd59e6089eef8aa1d40624c3264d.png "Logo Title Text 1")


Набор целых чисел , каждое из которых лежит в интервале от 0 до 255, является последовательностью байтов, составляющих M. При этом  называетсямладшим байтом, а  — старшим байтом числа M.
